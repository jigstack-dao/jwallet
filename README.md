# Jigstack wallet [![jWallet](https://wallet.jigstack.org/)](https://wallet.jigstack.org/)
...
You can Download the latest Jigstack wallet [here](https://github.com/jigstack-dao/jigstack-wallet/releases/latest).
...
Thanks for contributions from MetaMask team to browser extension wallet community, Jigstack wallet use (or fork) them to make Jigstack wallet better.
