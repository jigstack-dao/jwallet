...
const Row: React.FC<RowProps> = memo(function Row(props) {
...
const AddressList: any = forwardRef(function AddressList(
  {
    list,
    action = 'switch',
    ActionButton,
  ...
  const [, setEnd] = useState(10);
  const [editIndex, setEditIndex] = useState(0);

  const [alianNamesList] = useState(alianNames);
