...
import IconJigstack from 'ui/assets/dashboard/jigstack.svg';
import IconAddressManagement from 'ui/assets/icon-user.svg';
import IconLock from 'ui/assets/lock.svg';
import LogoJigstack from 'ui/assets/logo-jigstack-large.svg';
    ...
    >
      ...
      >
        <div className="field-main">
          <div className="field-title">
            Prefer Jwallet{' '}
            <img src={IconJigstack} className="w-[20px]" alt="" />
          </div>
          <div className="field-desc">
            Use Jwallet to connect DApps and submit transactions.
          </div>
        </div>
      </Field>
      <Field
      ...
      >
        <div className="field-main">
          ...
          <div className="field-desc">
            Use MetaMask to connect DApps and submit transactions. Jwallet's
      ...
      {!isDefaultWallet && (
        <div className="tips">
          *Choosing this will prevent Jwallet's pre-sign features from working
        </div>
      )}
    </div>
  );
...
const Settings = ({ visible, onClose }: SettingsProps) => {
  ...
  const [showResolveConflictModal, setShowResolveConflictModal] =
    useState(false);
  const [isDefaultWallet, setIsDefaultWallet] = useState(false);
        ...
        <div>
          ...
          {!isDefaultWallet && (
            <p className="not-default-tip">
              {t('Jwallet is currently not working properly')}
            </p>
          )}
        </div>
      ),
