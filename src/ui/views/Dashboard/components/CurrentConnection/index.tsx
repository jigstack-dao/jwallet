...
export const CurrentConnection = memo(function CurrentConnection() {
  ...
  const handleChangeDefaultChain = async (chainId: number) => {
    const _site = {
      ...site!,
      chainId,
    };
      ...
      {site ? (
        site.isConnected ? (
          ...
          <Tooltip
            ...
            title="JWallet is not connected to the current Dapp.To connect, find and click the connect button on the Dapp’s webpage."
          >
            {Content}
          </Tooltip>
        )
