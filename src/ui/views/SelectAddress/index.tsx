...
const SelectAddress = ({ isPopup = false }: { isPopup?: boolean }) => {
  ...
  const handleSelectChange = (
    res: Array<{ address: string; index: number }>
  ) => {
  ...
  return (
    <div className="select-address">
      <StrayPageWithButton
        ...
        className={clsx(isPopup && isWide && 'jigstack-stray-page')}
        header={
          isPopup
            ? undefined
            : isMnemonics
            ...
            : {
                title: t('Select the addresses to use in Jwallet'),
                center: true,
              }
        }
      ...
      >
          ...
          <div className="select-hdpath">
            ...
            >
              {HDPaths[keyring].map((path) => {
                return (
                  <Option key={path.name} value={path.value}>
                    {path.name}
                  </Option>
                );
              })}
        ...
        <div className={clsx(isPopup && 'jigstack-container')}>
          <div
