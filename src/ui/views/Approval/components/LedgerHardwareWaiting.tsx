  ...
  return (
    <div className="ledger-waiting">
      ...
      <div className="ledger-waiting__container">
        ...
        {connectStatus === WALLETCONNECT_STATUS_MAP.SUBMITTED && !isSignText && (
        ...
        {(connectStatus === WALLETCONNECT_STATUS_MAP.SUBMITTED ||
          connectStatus === WALLETCONNECT_STATUS_MAP.FAILED) && (
          <div
