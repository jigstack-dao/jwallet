...
const SecurityCheckDetail = ({
  ...
  return (
    <Drawer
      ...
      closeIcon={
        <img src={IconArrowRight} className="w-8 icon icon-drawer-close" />
      }
    >
      <div className="security-check-detail">
        <div className="container">
          {data.forbidden_list.length > 0 && (
            <div className="forbidden flex items-start mb-2">
              ...
              <ul>
                {data.forbidden_list.map((item) => (
                  <li key={`forbidden_${item.id}`}>
                    {item.alert} hello<span className="number">#{item.id}</span>
                  </li>
                ))}
              </ul>
            </div>
          ...
          {data.danger_list.length > 0 && (
            <div className="danger flex items-start mb-2">
              <div className="w-[70px]">
          ...
          {data.warning_list.length > 0 && (
            <div className="warning flex items-start mb-2">
              <div className="w-[70px]">
