  ...
  return (
    <div className="approve">
      ...
      <div className="gray-section-block common-detail-block">
        ...
        <p className="title-approve">{t('Token Approval')}</p>
            ...
            <p className="token-info" title={splitNumberByStep(tokenAmount)}>
              <span>
                ...
                <span title={detail.token_symbol}>
                  {ellipsisOverflowedText(detail.token_symbol, 7)}
                </span>
              </span>
              {!isGnosis && (
                <Button
                  ...
                  className="edit-btn"
                >
                  <img width={18} height={18} src={IconEdit} />
                </Button>
              )}
            </p>
            <p
