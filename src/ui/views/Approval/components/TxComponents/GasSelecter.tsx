...
import { Input, Button, Skeleton, Form, Slider, Tooltip, InputRef } from 'antd';
import BigNumber from 'bignumber.js';
import { ValidateStatus } from 'antd/lib/form/FormItem';
import { useTranslation, Trans } from 'react-i18next';
import { useDebounce } from 'react-use';
import { GAS_LEVEL_TEXT, MINIMUM_GAS_LIMIT } from 'consts';
    ...
    <>
      ...
      >
        <Form onFinish={handleConfirmGas}>
          <div className="gas-limit">
            ...
            <div className="expanded gas-limit-panel-wrapper">
              ...
              <div className={clsx({ 'opacity-50': disableNonce })}>
                <p className="section-title mt-4">{t('Nonce')}</p>
                <Form.Item className="gas-limit-panel mb-0" required>
                  <Input
                    className={clsx(
                      'popup-input',
                      disableNonce &&
                        'text-white cursor-not-allowed hover:border-white focus:border-white'
                    )}
                    value={customNonce}
          ...
          <div className="flex justify-center mt-8 popup-footer">
            <Button
              type="primary"
              className="w-full btn-confirm"
              size="large"
