...
import { useWallet, isSameAddress, sinceTime } from 'ui/utils';
...
import { SvgPendingSpin, SvgIconOpenExternal } from 'ui/assets';
    ...
    <div className="tx-history">
      ...
      {completeList.length <= 0 && pendingList.length <= 0 && (
        <Empty
          ...
          desc={t('All transactions signed via Jwallet will be listed here.')}
          className="pt-[108px]"
        ></Empty>
      )}
    </div>
