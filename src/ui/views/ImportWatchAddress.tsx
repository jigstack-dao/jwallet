...
import { Popup, StrayPageWithButton, Modal } from 'ui/component';
...
const ImportWatchAddress = () => {
  ...
  const allAccounts = async () => {
    ...
    if (importedAccounts?.[0]?.accounts) {
  ...
  return (
    <StrayPageWithButton
      ...
      hasDivider
      noPadding
      className={clsx('import-watchmode', isWide && 'jigstack-stray-page')}
      formProps={{
    ...
    >
      <header className="create-new-header create-password-header h-[264px] res">
        <div className="jigstack-container">
          <img
            className="jigstack-logo"
