...
import { CHAIN_LIST, CHAINS_ENUM } from './chains';
export { CHAINS_ENUM } from './chains';

export const { AddressZero, MaxUint256, Zero } = constants;
export const { JsonRpcProvider } = providers;

export const CHAINS = Object.values(CHAIN_LIST).reduce<Record<string, Chain>>(
  (m, n) => ({
    ...m,
    [n.enum]: n,
  }),
...
export const INTERNAL_REQUEST_ORIGIN = 'https://jigstack.org';
...
export const NETWORKS_SUPPORT_DEFAULT = [
  {
    chainId: 1,
    ...
    rpcURL: process.env.REACT_APP_RPC_URL_ETH || 'https://rpc.ankr.com/eth',
  },
  {
    chainId: 137,
    name: 'Polygon',
    ...
    rpcURL: process.env.REACT_APP_RPC_URL_POLYGON || 'https://polygon-rpc.com',
  },
  {
    chainId: 5,
    ...
    rpcURL:
      process.env.REACT_APP_RPC_URL_GOERLI_ETH ||
  ...
  },
  {
    ...
    symbol: 'MATIC',
    decimals: 18,
    scanLink: 'https://mumbai.polygonscan.com',
    rpcURL:
...
export const defaultNetwork = NETWORKS_SUPPORT_DEFAULT[0];

export enum TAB_SANTA_KEYS {
  SendGift = 'SendGift',
  MyGifts = 'My Gifts',
...
export const MIN_GWEI_UNIT = 1000000000;

export const BIG_NUMBER_ZERO = BigNumber.from(0);

export const SUM_MINUTES_OF_DAY = 1440;
