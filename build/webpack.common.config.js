...
const config = {
  entry: {
    "webextension-polyfill": paths.rootResolve('node_modules/webextension-polyfill'),
    background: [
      paths.rootResolve('node_modules/webextension-polyfill'),
      paths.rootResolve('src/background/index.ts')
    ],
